...
console.log("  vibe_tags[]           : NOT MODELLED -> curated (demo) / retrieval 5a");
console.log("  price_band (1-4)      : NOT MODELLED -> curated / retrieval 5a");
console.log("  centrality            : COMPUTED from centroid vs city centroid");
console.log("  transit_access_class  : COMPUTED from TT-07 stops within radius");
console.log("  best_for[]            : COMPUTED from FE-03 POI mix inside the polygon");
...
console.log("  => area_id / name / centroid are rung 1. The CHARACTER half is not,");
console.log("     and is curated for demo destinations then retrieval (5a) elsewhere.");
