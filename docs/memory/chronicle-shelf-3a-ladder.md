...
The 6 unwritten stories of **Shelf III slice A — the knowledge ladder** — how a task's knowledge climbs from memory to frozen record. One of seven
...
- [the spec](../record/specs/chronicle-shelf-3a-ladder.md) — roster, format,
