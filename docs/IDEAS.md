...
triaged during a roadmap review and promoted to ROADMAP or a GitHub issue.

- 2026-06-11 (Claude Code, after V1.S2.T2): add `paths-ignore:
...
- 2026-06-12 (Web, V1.S1.T1 amendment review): reachability globe —
...
- 2026-06-12 (Web, V1.S1.T1 amendment review): multi-origin trips and
