---
type: history
slug: parallel-lanes-native
shipped: 2026-07-09
pr: 51
---

# Parallel lanes go native
...
The D-020 turn. After --remote's bundle-seeded sandboxes destroyed the
batch-1 T3+T5 work and three launch-mechanic corrections landed in a
row, the hand-built cloud machinery was retired for what Claude Code
ships natively: background agents and worktree sessions, every lane
with a draft PR from birth and every commit pushed. CLAUDE.md slimmed;
the equipment plan moved to a skill.
