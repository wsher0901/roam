...
## Status
Shipped — merged as
[PR #113](https://github.com/wsher0901/roam/pull/113) on the
founder's word after external review. Every verification green; the
one rendering note (the raw "SOURCES-<family>" table cell) is
flagged for the leg-end sweep.

## What this task is
[HOME](../../../../HOME.md) closed the ops leg's knowledge layer:
...
twice on 2026-07-13 as the v2c shape landed — collapsed into two
pointers ([§Reading the board](../../../../HOME.md#reading-the-board)
...
## Left / idle
nothing here — the brief defers HOME's full Law-2 restyle to the
leg-end sweep (ratchet bent knowingly); LAWS is the next block.
