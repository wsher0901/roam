...
[the spec](../../../specs/chronicle-shelf-3c-surfaces.md).
...
| --- | --- | --- |
| WEB-INSTRUCTIONS | "v5 lives as the repo master" | v6 — [#240](https://github.com/wsher0901/roam/pull/240), [D-063](../../../DECISIONS.md#d-063--response-doctrine-v2-and-web-instructions-v6) |
| IDEAS | closed entries "deleted" | [D-066](../../../DECISIONS.md#d-066--the-ideas-entry-contract) amended it — they COMPRESS AND STAY |
| ATLAS | six diagrams, "settled" | eight SVG figures — [D-071](../../../DECISIONS.md#d-071--atlas-gains-the-enforcement-mesh) · [D-072](../../../DECISIONS.md#d-072--the-atlas-no-scroll-law) · [D-073](../../../DECISIONS.md#d-073--atlas-becomes-designed-figures) |
| DASHBOARD | the rendered state surface | + the board diet ([D-067](../../../DECISIONS.md#d-067--the-report-skeleton-and-the-board-diet)) and single-homed renderings ([D-070](../../../DECISIONS.md#d-070--baton-renderings-single-homed)) |
| HOME | pre-groom role list | the LAWS register split ([D-069](../../../DECISIONS.md#d-069--the-law-register-and-the-manual-groom)) + the connector ladder ([D-065](../../../DECISIONS.md#d-065--the-box-master-diet)) |
| SETUP | "the single inventory" | the entry contract ([D-064](../../../DECISIONS.md#d-064--the-box-master-class-and-setup-entry-contract)) + the named VALUES home ([D-065](../../../DECISIONS.md#d-065--the-box-master-diet)) |
...
reconstructed from
[DECISIONS](../../../DECISIONS.md) and the live files, and the
...
- [the spec](../../../specs/chronicle-shelf-3c-surfaces.md) — roster, format,
