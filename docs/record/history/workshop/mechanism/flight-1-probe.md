...
entry in [record/history/](../..) after the weld.
...
- **The flip is inferred, not observed.** The probe's BORN section
  ...
  [the spec](../../../specs/flight-1-probe.md) forbids, in the
...
- [the probe](../../../probes/flight-1-shakedown.md) — THE PAYLOAD:
  the flight's own log, frozen as the view from one seat.
- [the spec](../../../specs/flight-1-probe.md) — the contract and
  the simulation law.
