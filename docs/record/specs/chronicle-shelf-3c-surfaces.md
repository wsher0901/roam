...
Write the **7 unwritten stories** of Shelf III slice C — surfaces & manuals — the files a reader actually opens.
...
1. **HOME — the manual and encyclopedia** — `system piece`
2. **DASHBOARD — the board** — `system piece`
3. **IDEAS — the single inbox** — `system piece`
4. **ATLAS — the system spine** — `system piece`
5. **recall — the read mirror** — `system piece`
6. **WEB-INSTRUCTIONS — the Web surface's rule-carrier** — `system piece`
7. **SETUP — the equipment inventory** — `system piece`
