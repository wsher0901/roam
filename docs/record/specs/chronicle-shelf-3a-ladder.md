...
title: Shelf III slice A — the knowledge ladder — the chronicle stories
status: open
stage: workshop
branch: docs/chronicle-shelf-3a-ladder
pr: —
opened: 2026-08-06
shipped: —
---
...
Write the **6 unwritten stories** of Shelf III slice A — the knowledge ladder — how a task's knowledge climbs from memory to frozen record.
...
1. **the narrative layer — memory that becomes history** — `system piece`
2. **the memory TEMPLATE and the Status vocabulary** — `system piece`
3. **the ledger and its integrity gate** — `system piece`
4. **the specs system** — `system piece`
5. **the record shelf — docs/record/** — `system piece`
6. **the chronicle layer — living stories above the record** — `system piece`
...
- [ ] 6 story files exist in `docs/chronicle/`, one per roster
