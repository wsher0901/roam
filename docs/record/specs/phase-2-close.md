...
## THE BLOCKING QUESTION — surfaced, not decided
...
- **Ruling on the polish pass.** Founder's call; see above.
...
- [ ] The closing D-number exists and states the polish pass's fate
