...
Write the **11 unwritten stories** of Shelf I — the away surface — how the founder leaves the desk and commands from away.
...
1. **handoff — the ground-seat leaving ritual** — `system piece`
2. **liftoff — hand the workshop to the cloud** — `system piece`
3. **the cockpit — the control tower online** — `system piece`
4. **the cockpit's birth vehicle** — `system piece`
5. **the cockpit's connector resilience** — `system piece`
6. **the cloud clerk — born and retired** — `system piece`
7. **the away-mode chooser** — `system piece`
8. **go-remote / Remote Control — the tether** — `system piece`
9. **team-aware leaving** — `system piece`
10. **the Shakedown Flight (2026-07-17 → 19)** — `event`
11. **the cockpit's proving flights (07-22 · 07-23)** — `event`
