...
title: Shelf II — the lane system — the chronicle stories
status: open
stage: workshop
branch: docs/chronicle-shelf-2-lanes
pr: —
opened: 2026-08-06
shipped: —
---
...
Write the **11 unwritten stories** of Shelf II — the lane system — parallel work and its machinery.
...
1. **the lane law — the seven-clause contract** — `system piece`
2. **lane liveness — live vs reclaimable** — `system piece`
3. **fleet continuity — park, respawn, the protocol** — `system piece`
4. **the cloud spawn route ladder + lane-worker routine** — `system piece`
5. **lane vehicles** — `system piece`
6. **the hands doctrine (solo · subagents · team · lanes)** — `system piece`
7. **agent teams — the boundary** — `system piece`
8. **the reviewer subagent — the ship-time critic** — `system piece`
9. **the delegation maiden flight (2026-07-16)** — `event`
10. **Shakedown phase 2, the lane half (2026-07-17)** — `event`
11. **the batch-1 lane launch (2026-06-12)** — `event`
...
- [ ] 11 story files exist in `docs/chronicle/`, one per roster
