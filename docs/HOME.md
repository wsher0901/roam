...
| [ATLAS.md](ATLAS.md) | the system spine — the workshop as seven diagrams on one page; renders, originates nothing (the prose governs) | the bench that changes what a diagram depicts — re-rendered in that same PR | living; dated stamp, least-authoritative; loses every disagreement with its linked prose |
