...
> now fails honestly in [`scripts/fire.mjs`](../../scripts/fire.mjs).
> The API-fire mechanism this bench proved lives on as
> `fire:cockpit`, the cockpit birth ladder's routine-fire rung
