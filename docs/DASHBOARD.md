...
closeout bench opens; THE CHRONICLE LAYER gets its own chat — and
is now also the first intended AGENT-TEAM use (three threads, one
teammate each, disjoint files, a single sitting).
