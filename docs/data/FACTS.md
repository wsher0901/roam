...
Ask tiers ([D-012](../record/DECISIONS.md#d-012--elicitation-and-inference-policy)): U = upfront (capped at six questions: origin,
...
| TP-43 | Units | metric/us | S — default metric ([D-013](../record/DECISIONS.md#d-013--canonical-units-si-storage)) | display conversion | engine |
...
([V1.S1.T1](../ROADMAP.md#v1s1--data-definition-the-gate-docs--spike-scripts-only-no-app-code) amendment review, purposes P3–P6; [D-014](../record/DECISIONS.md#d-014--telemetry-posture), [D-015](../record/DECISIONS.md#d-015--data-asset-law))
...
where).
Demotion law ([D-015](../record/DECISIONS.md#d-015--data-asset-law)): sustained failure, drift, or §2 miscalibration
...
data strictly separated from traveler and event data ([D-015](../record/DECISIONS.md#d-015--data-asset-law)).
