...
branch feat/v1.s1.t1-fact-inventory) or V1.S2.T1 (app scaffold, branch
feat/v1.s2.t1-scaffold; per equipment plan, add Supabase + Vercel MCP
when S2 work starts). Re-upload changed docs (FOUNDATION.md, ROADMAP.md,
DECISIONS.md, CLAUDE.md) to the Claude Web Project. Optional: set
`git config roam.machine "<label>"` per computer.
